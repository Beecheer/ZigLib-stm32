...
pub extern fn boardBuzzerStart(freq: u32) void;
pub extern fn boardBuzzerStop() void;
pub extern fn boardDWTInit() void;
pub extern fn boardDWTDelayUs(us: u32) void;
pub extern fn boardDWTDelayMs(ms: u32) void;
pub extern fn boardLedOn_1() void;
pub extern fn boardLedOff_1() void;
pub extern fn boardLedToggle_1() void;
pub extern fn boardLedOn_2() void;
pub extern fn boardLedOff_2() void;
pub extern fn boardLedToggle_2() void;
pub extern fn boardUartSend_1(pData: [*c]const u8, Size: u16) void;
pub extern fn boardUartReceiveDMA_1(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartReceiveDMAtoIdle_1(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartSend_2(pData: [*c]const u8, Size: u16) void;
pub extern fn boardUartReceiveDMA_2(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartReceiveDMAtoIdle_2(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartSend_3(pData: [*c]const u8, Size: u16) void;
pub extern fn boardUartReceiveDMA_3(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartReceiveDMAtoIdle_3(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartSend_5(pData: [*c]const u8, Size: u16) void;
pub extern fn boardUartReceiveDMA_5(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartReceiveDMAtoIdle_5(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartSend_7(pData: [*c]const u8, Size: u16) void;
pub extern fn boardUartReceiveDMA_7(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartReceiveDMAtoIdle_7(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartSend_10(pData: [*c]const u8, Size: u16) void;
pub extern fn boardUartReceiveDMA_10(pData: [*c]u8, Size: u16) void;
pub extern fn boardUartReceiveDMAtoIdle_10(pData: [*c]u8, Size: u16) void;
pub extern fn userUartRxIdleCallback_1(Size: u16) void;
pub extern fn userUartRxIdleCallback_2(Size: u16) void;
pub extern fn userUartRxIdleCallback_3(Size: u16) void;
pub extern fn userUartRxIdleCallback_5(Size: u16) void;
pub extern fn userUartRxIdleCallback_7(Size: u16) void;
pub extern fn userUartRxIdleCallback_10(Size: u16) void;
pub extern fn userUartRxCpltCallback_1() void;
pub extern fn userUartRxCpltCallback_2() void;
pub extern fn userUartRxCpltCallback_3() void;
pub extern fn userUartRxCpltCallback_5() void;
pub extern fn userUartRxCpltCallback_7() void;
pub extern fn userUartRxCpltCallback_10() void;
pub extern fn boardWS2812Init() void;
pub extern fn boardWS2812WriteByte(data: u8) void;
pub extern fn boardCanAddFilter_1(rx_id: u32) void;
pub extern fn boardCanStart_1() void;
pub extern fn boardCanSend_1(tx_id: u32, data: [*c]const u8, size: u32) void;
pub extern fn boardCanAddFilter_2(rx_id: u32) void;
pub extern fn boardCanStart_2() void;
pub extern fn boardCanSend_2(tx_id: u32, data: [*c]const u8, size: u32) void;
pub extern fn boardCanAddFilter_3(rx_id: u32) void;
pub extern fn boardCanStart_3() void;
pub extern fn boardCanSend_3(tx_id: u32, data: [*c]const u8, size: u32) void;
pub extern fn userCanCallback_1(id: u32, len: u32, data: [*c]u8) void;
pub extern fn userCanCallback_2(id: u32, len: u32, data: [*c]u8) void;
pub extern fn userCanCallback_3(id: u32, len: u32, data: [*c]u8) void;
pub extern fn boardInit() void;
pub extern fn boardDelay(ms: u32) void;
...
pub const __INTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `L`"); // <builtin>:90:9
pub const __UINTMAX_TYPE__ = c_ulonglong;
pub const __UINTMAX_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `UL`"); // <builtin>:92:9
...
pub const __INT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `LL`"); // <builtin>:113:9
...
pub const __UINT32_FMTX__ = "X";
pub const __UINT32_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `U`"); // <builtin>:135:9
...
pub const __UINT64_FMTX__ = "llX";
pub const __UINT64_C_SUFFIX__ = @compileError("unable to translate macro: undefined identifier `ULL`"); // <builtin>:143:9
...
pub const __stdint_int_c_cat = @compileError("unable to translate C expr: unexpected token '##'"); // C:\Users\zhangzhiwen\.zvm\master\lib\compiler\aro\include\stdint.h:12:9
...
pub const __stdint_uint_c = @compileError("unable to translate macro: undefined identifier `U`"); // C:\Users\zhangzhiwen\.zvm\master\lib\compiler\aro\include\stdint.h:14:9
